...
def ch_work_directory():
    import os, sys
    if os.getcwd() == '/home/ldc/PycharmProjects/Dy/compress_model':
        os.chdir('..')
...
import mxnet as mx
from layers.sphere_net import AngleLoss, test_accur
from layers.data import train_valid_test_loader
# from layers.dy_conv import origin_conv, new_conv, constrain_kernal_num
from layers.params import gls  # , alpha, compressed_root  # global_param,
from units import getParmas, init_sphere

from compress_model.general_conv import SphereNet20_3
